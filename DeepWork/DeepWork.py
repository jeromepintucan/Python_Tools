...
class ProcessKeeperApp:
    """Tkinter user interface for DeepWork."""
    ...
    def _create_interface(self) -> None:
        ...
        self.info_label = tk.Label(
            ...
            text=(
                ...
                "The application also nudges the mouse by 1 pixel "
                "roughly every minute so apps like Teams continue "
                "reporting you as active.\n\n"
    ...
    def _jiggle_tick(self) -> None:
        """Perform one jiggle while protection is active and reschedule."""
        if self.keeper.active:
            try:
